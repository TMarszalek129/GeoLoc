 ...
 */
// Based on Android Tutorial https://github.com/android/codelab-while-in-use-location
...
class MainActivity : AppCompatActivity(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private fun logResultsToURL(latitude: Double, longitude: Double)
    {
        // Enter URL here
        var url = ""

        // add parameter
        val formBody = FormBody.Builder().add("message", latitude.toString() + ", " + longitude.toString())
            .build()
    ...
    private inner class ForegroundOnlyBroadcastReceiver : BroadcastReceiver() {
        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            if (location != null) {
                ...
                logResultsToURL(latitude, longitude)
